...
//
    ...
    private final static String HOST = "192.168.6.18"; // 공통 ip
//    private final static int HTTP_PORT = 9101; // 정호 port
    private final static int HTTP_PORT = 9102; // 씹영훈 port
//    private final static int HTTP_PORT = 9103; // 용범 port
...
//    }
    ...
    protected T parse(ResponseBody body) throws IOException {
        ...
        if (temp.getCode() == 1) { // 성공
            ...
            Type type = new TypeToken<ResultMessage<String>>() {
            }.getType();
            ResultMessage<String> result = gson.fromJson(text, type);
